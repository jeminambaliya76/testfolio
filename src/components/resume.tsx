...
export function Resume() {
  // Resume details
const resumeDetails = {
  title: "Purvi's Resume",
  description: 'Full Stack Developer • React, Node.js, MongoDB',
  fileType: 'PDF',
  lastUpdated: 'June 2025',
  fileSize: '0.5 MB',
  previewImageSrc: '/resume_purvi_preview.png', // Replace with your image
  downloadUrl: '/resume_purvi.pdf', // Replace with your file
};
