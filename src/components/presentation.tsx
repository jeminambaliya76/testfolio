...
const profile = {
  ...
  location: 'USA', // or your actual city
  description:
    "Hey 👋\nI'm Purvi, a Full Stack Developer with 6+ years of experience in React, Node.js, and modern web ecosystems. I specialize in building scalable, secure, and user-friendly web apps for startups and businesses.",
  src: '/profile-purvi.png', // Replace with your image if hosted locally
  fallbackSrc:
    'https://patelpurvi.com/images/profile.png', // Optional: Replace with a more personalized image
};
      ...
      <div className="grid grid-cols-1 items-center gap-10 md:grid-cols-2">
        ...
        <div className="flex flex-col space-y">
          ...
          <motion.p
            initial="hidden"
            animate="visible"
            variants={paragraphAnimation as any}
